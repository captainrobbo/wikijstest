...
**Nationality**: This field is used to help decipher the Team ID. If you are from the UK and enter a Team ID of 'BEL' then the system will look for the club code 'BEL' within UK and return the Belgrave Harriers club. However, if you are from Italy and enter 'BEL' it will look for an italian club with that code and so on. If you are unaware of the country ID, please email *support@opentrack.run*.
